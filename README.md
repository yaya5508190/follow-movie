...
推荐使用 Docker Compose 进行一键部署，详见 [Docker 部署指南](script/docker/DEPLOYMENT_GUIDE.md)。
...
完整部署说明请查看：[📖 Docker 部署完整指南](script/docker/DEPLOYMENT_GUIDE.md)
...
| 插件 | 功能 | 状态 |
|------|------|------|
| **media-hub** | 媒体库管理，提供统一的媒体资源展示和管理 | ✅ 可用 |

### 认证插件

| 插件 | 功能 | 状态 |
|------|------|------|
| **z-space** | Z-Space 站点预认证，支持多站点统一认证 | ✅ 可用 |
...
- [Docker 部署完整指南](script/docker/DEPLOYMENT_GUIDE.md)
- [前端构建说明](script/fronted/BUILD_SCRIPTS_README.md)
